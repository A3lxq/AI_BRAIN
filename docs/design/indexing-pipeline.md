...
- **Date:** 2026-09-02
- **Author:** Claude Code (AI_BRAIN Phase 3)
...
- **Chonkie's actual heading-boundary behavior against AI_BRAIN's real turn-header shapes** — asserted as *likely* fine in §2.2 based on general ATX-header reasoning, not yet empirically proven. The test in §7 is the actual verification; until it's run, this remains a stated assumption, not a confirmed fact.

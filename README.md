...
5. Claude Code must follow `docs/DEVELOPMENT_CONSTITUTION.md`.
6. Complete Phase 0 before implementation.
7. Research technologies and write research artifacts before selecting them.
8. Use ADRs for significant decisions.
9. Implement bottom-up and test every layer before moving upward.
10. End every session by updating the continuity files.
